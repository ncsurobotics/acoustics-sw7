...
# Location of each of the hydrophones
...
'''
Takes the time difference of arrival and generates an angle from it
'''
...
# Load data based off conf argument and data run argument
